...
public class HawkConfig {
    ...
    /** Fingerprint of the source keys used when a saved search selection was made. */
    public static final String SOURCES_FOR_SEARCH_KEYS = "checked_sources_for_search_keys";
