        ...
        switch (fileName) {
            case "/action":
                if (params.get("do") != null && mDataReceiver != null) {
                    ...
                    switch (action) {
                        case "search": {
                            mDataReceiver.onTextReceived(getValue(params, "word"));
                            break;
                        }
                        case "api": {
                            mDataReceiver.onApiReceived(getValue(params, "url"));
                            break;
                        }
                        case "liveApi": {
                            mDataReceiver.onLiveApiReceived(getValue(params, "url"));
                            break;
                        }
                        case "danmuApi": {
                            mDataReceiver.onDanmuApiReceived(getValue(params, "url"));
                            break;
                        }
                        case "push": {
