...
public class HomeActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        ViewGroup.MarginLayoutParams topLp = (ViewGroup.MarginLayoutParams) this.topLayout.getLayoutParams();
        this.topBarHeight = topLp.height;
        this.topBarMarginTop = topLp.topMargin;
    ...
    private void changeTop(boolean hide) {
        ...
        if (hide && topHide == 0) {
            animatorSet.playTogether(ObjectAnimator.ofObject(viewObj, "marginTop", new IntEvaluator(),
                            Integer.valueOf(topBarMarginTop),
                            Integer.valueOf(0)),
                    ObjectAnimator.ofObject(viewObj, "height", new IntEvaluator(),
                            Integer.valueOf(topBarHeight),
                            Integer.valueOf(1)),
